...
class qc_medical_expense_credit_eligible(Variable):
    value_type = bool
    entity = Person
    label = "Quebec medical expenses tax credit eligibility"
    ...
    def formula(person, period, parameters):
        ...
        return age_eligible * work_income_eligible * family_income_eligible
