...
class ns_chargeable_earned_income(Variable):
    ...
    def formula(person, period, parameters):
       ...
       chargeable_earned_income = p.earned_income_exemption_rates.calc(earned_income)
       # chargeable earned income for general employment
       chargeable_earned_income_supported = p.earned_income_exemption_rates_supported.calc(earned_income)
       # chargeable earned income for supported employment
        return (is_disabled, chargeable_earned_income_supported, chargeable_earned_income)
