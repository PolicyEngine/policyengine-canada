...
class ns_income_assistance_not_applicable_assets(Variable):
    value_type = float
    entity = Household
    label = "Nova Scotia income assistance not applicable assets"
    unit = CAD
    definition_period = YEAR
    reference = "https://novascotia.ca/just/regulations/regs/esiaregs.htm#TOC2_4"  # Section 25
