...
class sk_housing_benefit(Variable):
    ...
    def formula(household, period, parameters):
        ...
        p2 = variables(period).gov.provinces.sk.tax.income
        ...
        housing_percentage = (rent + household("utilities_costs", period)) / income
