...
class sk_cpp_at_home(Variable):
    value_type = float
    entity = Household
    label = "Saskatchewan CPP annually income client category - living at home"
    ...
    def formula(household, period, parameters):
        ...
        return eligible * (select(
            ...
            # Results.
            [
                p.living_at_home.cpp_income.single, 
                p.living_at_home.cpp_income.married_both_pensioners,
                p.living_at_home.cpp_income.married_spouse_below_age_threshold,
                p.living_at_home.cpp_income.married_spouse_receiving_allowance,
            ],
            default=0,
        ))
