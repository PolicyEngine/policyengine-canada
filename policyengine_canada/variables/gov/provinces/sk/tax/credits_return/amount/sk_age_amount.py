...
class sk_age_amount(Variable):
    ...
    def formula(person, period, parameters):
        ...
        reduction = (income > p.net_income_base_amount) * (income - p.net_income_base_amount) * p.reduction_rate
        
        return eligible * (income < p.net_income_maximum_amount) * (p.age_amount - reduction)
